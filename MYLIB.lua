...
local Library do 
	Library = {
        ...
        Folders = {
            Directory = "zerohub",
            Configs = "zerohub/Configs",
            Assets = "zerohub/Assets",
			Sounds = "zerohub/Sounds",
        },
...
local Themes = {
    ["Preset"] = {
        ["Window Outline"] = FromRGB(10, 10, 15),
        ["Accent"] = FromRGB(0, 200, 255),
        ["Background 1"] = FromRGB(13, 18, 35),
        ["Text"] = FromRGB(255, 255, 255),
        ["Inline"] = FromHex('#0d1223'),
        ["Element"] = FromHex('#111a32'),
        ["Inactive Text"] = FromRGB(150, 150, 170),
        ["Border"] =  FromHex('#1a2540'),
        ["Background 2"] = FromRGB(16, 22, 40)
    }
}
    ...
    Library.Window = function(self, Data)
        ...
        local Items = { } do
            Items["MainFrame"] = Instances:Create("Frame", {
                ...
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(13, 18, 35)
    ...
    Library.Sections.Toggle = function(self, Data)
        ...
        local Items = { } do 
            ...
            Items["IndicatorOutline"] = Instances:Create("Frame", {
                ...
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(40, 45, 60)
            ...
            Items["IndicatorInline"] = Instances:Create("Frame", {
                ...
                BorderSizePixel = 0,
                BackgroundColor3 = FromRGB(0, 200, 255)
        ...
        function Toggle:Set(Value)
            ...
            if Toggle.Value then 
                Items["IndicatorInline"]:Tween(TweenInfo.new(0.35, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(0, 9, 0.5, 0), BackgroundTransparency = 0})
                Items["IndicatorOutline"]:Tween(TweenInfo.new(0.35, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {BackgroundColor3 = FromRGB(0, 150, 200)})
            else
                Items["IndicatorInline"]:Tween(TweenInfo.new(0.35, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2New(0, 1, 0.5, 0), BackgroundTransparency = 0})
                Items["IndicatorOutline"]:Tween(TweenInfo.new(0.35, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {BackgroundColor3 = Library.Theme.Element})
            end
